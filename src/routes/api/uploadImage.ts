...
export const post: RequestHandler = async ({ request }) => {
    ...
    image.contain(Math.min(image.getWidth(), 800), Math.min(image.getHeight(), 1000), jimp.HORIZONTAL_ALIGN_CENTER | jimp.VERTICAL_ALIGN_MIDDLE)
